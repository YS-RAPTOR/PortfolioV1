        ...
        <div className="h-full w-full flex flex-grow">
            <div className="flex flex-col justify-center gap-y-16 p-10 min-w-max xs:min-w-[400px] sm:min-w-[625px] md:min-w-[730px] lg:min-w-[950px] mx-auto">
                <div className="flex flex-col gap-y-2">
                    <div className="text-lime-300 3xl:text-2xl font-bold inline-block self-start">
                        <GlitchTextStaggered text={"Hi my name is"} iterations={5}></GlitchTextStaggered>
                    </div>
                    <div className="text-white  text-5xl sm:text-6xl  md:text-7xl  lg:text-8xl font-bold inline-block self-start">
                ...
                <div className="flex flex-col gap-y-2">
                    <div className="text-lime-300 3xl:text-2xl font-bold inline-block self-end">
