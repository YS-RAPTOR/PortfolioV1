...
const GlitchTextStaggered = ({
	...
	const [glitchHandler, _] = useState(
		new GlitchHandler(iterations, iterDelay, textCap, direction)
	);
	...
	return (
		<GlitchedText
			...
			variants={variants}
			variantsCon={variantsCon}
			hover={hoverGlitch}
			entranceGlitch={entranceGlitch}
		/>
	);
};
...
const GlitchedText = ({
	...
	variantsCon: any;
	hover: boolean;
	entranceGlitch: string;
}) => {
	const [displayedText, setDisplayedText] = useState<string>(
		handler.GetRandomString()
	);
